...
named_type(address, Name) -> {named, address, Name};
named_type(bool, Name) -> {named, bool, Name};
named_type(function, Name) -> {named, function, Name};
named_type(string, Name) -> {named, string, Name};
named_type(bytes, Name) -> {named, bytes, Name};
named_type(int, Name) -> {named, juxt_type(int, 256), Name};
